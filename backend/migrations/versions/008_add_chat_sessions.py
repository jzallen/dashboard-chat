...
Changes:
- Add chat_sessions table for tracking chat conversations
- Add chat_turns table for tracking individual turns within sessions
- Add index on (session_id, sequence) for efficient turn ordering
"""
...
def downgrade():
    """Remove chat_sessions and chat_turns tables."""
