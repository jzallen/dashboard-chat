...
def test_ingress_handler_is_a_python_lambda_with_the_expected_entrypoint(template: Template):
    template.has_resource_properties(
        "AWS::Lambda::Function",
...
def test_pump_consume_policy_grants_drain_rights_and_is_attached_to_nothing(template: Template):
    template.has_resource_properties(
