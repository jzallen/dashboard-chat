...
from ...models.transform_create_batch import TransformCreateBatch
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        dataset_id (str):
        body (TransformCreateBatch): Request body for POST /datasets/:id/transforms — batch
            create.
