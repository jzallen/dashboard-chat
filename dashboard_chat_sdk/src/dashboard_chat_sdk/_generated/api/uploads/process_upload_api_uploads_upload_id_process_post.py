...
from ...models.process_upload_api_uploads_upload_id_process_post_body import (
...
def _get_kwargs(
    upload_id: str,
    *,
    body: ProcessUploadApiUploadsUploadIdProcessPostBody,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/uploads/{upload_id}/process".format(
