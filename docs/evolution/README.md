...
- [2026-05-12-user-flow-state-machines/](2026-05-12-user-flow-state-machines/FINALIZE.md) — server-owned flow state machines + scope chain; new `flow-state` Hono tier + `frontend-remix`; ratifies ADR-027..031.
