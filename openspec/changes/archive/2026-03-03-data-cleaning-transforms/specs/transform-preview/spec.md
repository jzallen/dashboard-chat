# Capability: transform-preview

Backend endpoint that evaluates a proposed cleaning operation against actual dataset data and returns impact statistics without persisting anything.
