...
Defines the multi-agent LangGraph pipeline that decomposes dashboard generation into narrow sub-problems: planning section structure, generating per-section components in parallel, selecting filters, assembling results, and validating coherence with retry.
