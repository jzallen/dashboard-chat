# dataset-resolution Specification

## Purpose
Defines the SSE-based protocol for agent-initiated dataset resolution, the backend search endpoint, and frontend fulfillment of resolve_dataset requests.
