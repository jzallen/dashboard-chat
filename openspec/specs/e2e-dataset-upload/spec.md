# e2e-dataset-upload Specification

## Purpose
End-to-end tests for the dataset upload flow, covering file upload via chat panel, dataset renaming, and upload error handling.
