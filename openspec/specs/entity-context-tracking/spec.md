# entity-context-tracking Specification

## Purpose
Decouples entity context (active dataset/view/report) from the chat session, allowing users to switch entities without creating new sessions or Stream channels.
