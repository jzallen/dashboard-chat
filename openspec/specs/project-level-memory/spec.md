# project-level-memory Specification

## Purpose
Defines how all sessions within a project share a single Stream channel (memory) and how thread-based conversation continuity works for agent context.
