# project-memory-mapping Specification

## Purpose
Maps each project to exactly one Stream channel (memory), enforced by a UNIQUE constraint. Provides the memory retrieval endpoint for frontend consumption.
