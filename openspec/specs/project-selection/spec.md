# project-selection Specification

## Purpose
Defines project selection as the entry point to the chat interface, requiring a project to be chosen before sessions are accessible.
