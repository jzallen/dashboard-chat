...
Defines the SemanticManifest Pydantic model hierarchy that describes available data sources, metrics, dimensions, and relationships in a dbt/MetricFlow-aligned format. Used as input to the planner pipeline.
