...
## Purpose
CRUD operations for sessions backed by Stream threads within a project's memory channel. Covers creation, listing with cursor pagination, metadata updates, and indefinite persistence.
