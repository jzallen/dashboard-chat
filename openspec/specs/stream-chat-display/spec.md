# stream-chat-display Specification

## Purpose
Defines the Chat Panel rendering using Stream React SDK primitives, replacing custom message components with Stream's built-in ChannelList, MessageList, and MessageInput.
