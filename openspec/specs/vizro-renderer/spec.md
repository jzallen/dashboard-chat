...
Converts DashboardPlan models deterministically into Vizro Dashboard models for rendering. Includes chart function registry, data manager integration, and app serving.
