...
Feature: Sign-in and org-setup error paths are honest and recoverable
  ...
  @us-001 @error-path @workos_profile_corrupt @real-io @clean
  ...
  @us-002 @error-path @org_validation_failed @real-io @clean
  ...
  @us-002 @error-path @jwt_reissue_failed_after_org_create @real-io @clean
  ...
  @us-001 @us-002 @degraded @with-stale-config
