...
Given(
  ...
  function (this: UserFlowWorld) {
    notEnabled(this, "slow identity provider");
  },
);
...
Given(
  ...
  function (this: UserFlowWorld) {
    notEnabled(this, "fake workos profile missing email");
  },
);
...
Given(
  ...
  function (this: UserFlowWorld, _name: string) {
    notEnabled(this, "duplicate org name precondition");
  },
);
...
Given(
  ...
  function (this: UserFlowWorld) {
    notEnabled(this, "transient access reissue failure");
  },
);
...
Given(
  ...
  function (this: UserFlowWorld) {
    notEnabled(this, "permanent access reissue failure");
  },
);
...
Given(
  ...
  function (this: UserFlowWorld) {
    notEnabled(this, "stale ingress config precondition");
  },
);
...
Given(
  ...
  function (this: UserFlowWorld) {
    notEnabled(this, "identity route migration");
  },
);
...
When("Maya begins signing in through the production ingress", async function (
  ...
  notEnabled(this, "Maya begins signing in (slow path)");
});

Then(
  /^within 100 milliseconds Maya sees a "Checking your identity\.\.\." panel$/,
  function (this: UserFlowWorld) {
    notEnabled(this, "checking identity panel visibility");
  },
);
...
Then(
  ...
  function (this: UserFlowWorld, _text: string) {
    notEnabled(this, "reassurance copy on checking panel");
  },
);
...
Then(
  ...
  function (this: UserFlowWorld) {
    notEnabled(this, "no blank/raw-error invariant");
  },
);
...
Then(
  ...
  function (this: UserFlowWorld, _email: string) {
    notEnabled(this, "eventually welcome page");
  },
);
...
Then(
  ...
  function (this: UserFlowWorld) {
    notEnabled(this, "recoverable-error instead of welcome");
  },
);
...
Then(
  ...
  function (this: UserFlowWorld) {
    notEnabled(this, "reference code visible on recoverable error");
  },
);
...
Then(
  ...
  function (this: UserFlowWorld) {
    notEnabled(this, "no silent welcome with blank greeting");
  },
);
...
Given(
  ...
  function (this: UserFlowWorld, _email: string) {
    notEnabled(this, "Maya is on the welcome page");
  },
);
...
When(
  ...
  function (this: UserFlowWorld, _name: string) {
    notEnabled(this, "Maya submits org name");
  },
);

Then("Maya stays on the welcome page", function (this: UserFlowWorld) {
  notEnabled(this, "remain on welcome page after rejection");
});

Then(
  /^Maya sees "([^"]+)" beside the input$/,
  function (this: UserFlowWorld, _text: string) {
    notEnabled(this, "inline validation message");
  },
);
...
Then(
  ...
  function (this: UserFlowWorld, _name: string) {
    notEnabled(this, "exactly one org after recovery");
  },
);
...
Then(
  ...
  function (this: UserFlowWorld, _name: string) {
    notEnabled(this, "app shell shows org on first paint");
  },
);
...
Then(
  ...
  function (this: UserFlowWorld) {
    notEnabled(this, "partial-setup copy variant");
  },
);
...
Then(
  ...
  function (this: UserFlowWorld) {
    notEnabled(this, "try-again scope: only reissue");
  },
);
...
Then(
  ...
  function (this: UserFlowWorld, _name: string) {
    notEnabled(this, "exactly one org overall");
  },
);
...
Then(
  ...
  function (this: UserFlowWorld) {
    notEnabled(this, "legacy frontend responds for unmigrated routes");
  },
);
