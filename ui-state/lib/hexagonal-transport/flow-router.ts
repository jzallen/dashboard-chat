...
// coordinator actor, whose router (`lib/machines/chat-app/router.ts`) owns its
// own `/projection` + `/projection/stream` (derived views) and serves no
// freeze/thaw — auth-proxy owns the token lifecycle.
//
// References:
